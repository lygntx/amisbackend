...
- 🎯 Entry points to execute your program using `python -m <amisbackend>` or `$ amisbackend` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/lygntx/amisbackend/branch/main/graph/badge.svg?token=amisbackend_token_here)](https://codecov.io/gh/lygntx/amisbackend)
[![CI](https://github.com/lygntx/amisbackend/actions/workflows/main.yml/badge.svg)](https://github.com/lygntx/amisbackend/actions/workflows/main.yml)

Awesome amisbackend created by lygntx

## Install

from source
```bash
git clone https://github.com/lygntx/amisbackend amisbackend
cd amisbackend
make install
```
...
```bash
pip install amisbackend
```

## Executing

```bash
$ amisbackend run --port 8080
```

or

```bash
python -m amisbackend run --port 8080
```

or

```bash
$ uvicorn amisbackend:app
```
...
```bash
❯ amisbackend --help
Usage: amisbackend [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ amisbackend create-user --help
Usage: amisbackend create-user [OPTIONS] USERNAME PASSWORD
...
```bash
amisbackend create-user admin admin --superuser
```
...
Run with `amisbackend run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `amisbackend create-user`.
...
-----------------------------------------------------
amisbackend/__init__.py              4      0   100%
amisbackend/app.py                  16      1    94%
amisbackend/cli.py                  21      0   100%
amisbackend/config.py                5      0   100%
amisbackend/db.py                   10      0   100%
amisbackend/models/__init__.py       0      0   100%
amisbackend/models/content.py       47      1    98%
amisbackend/routes/__init__.py      11      0   100%
amisbackend/routes/content.py       52     25    52%
amisbackend/routes/security.py      15      1    93%
amisbackend/routes/user.py          52     26    50%
amisbackend/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in amisbackend/default.toml.
