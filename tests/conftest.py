...
# WARNING: Ensure imports from `amisbackend` comes after this line
from amisbackend import app, settings, db  # noqa
from amisbackend.cli import create_user, cli  # noqa
